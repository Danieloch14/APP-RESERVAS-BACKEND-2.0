...
public class User implements Serializable {
	...
	public User(Integer idUser, PersonalData personalData, String username, String password, Date dateEntry, Date dateLastLogin, boolean isActive, boolean isNotLocked) {
		this.idUser = idUser;
